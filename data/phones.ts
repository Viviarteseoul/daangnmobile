...
export const PHONES_DATA: Phone[] = [
  ...
  },
  {
    id: "galaxy-fold8",
    name: "갤럭시 Z 폴드 8 5G",
    subName: "256GB / 초슬림 폴더블 AI • S펜 지원",
    brand: "Samsung",
    image: "https://images.unsplash.com/photo-1580910051074-3eb694886505?w=500&auto=format&fit=crop&q=80",
    releasePrice: 2238700,
    carrierDiscounts: {
      skt: { gongsi: 650000, storeDiscount: 450000, defaultPlan: "5G 프라임 (월 8.9만)", planPrice: 89000 },
      kt: { gongsi: 670000, storeDiscount: 460000, defaultPlan: "스페셜 5G (월 9.0만)", planPrice: 90000 },
      lgu: { gongsi: 700000, storeDiscount: 480000, defaultPlan: "5G 프리미어 (월 8.5만)", planPrice: 85000 },
    },
    tags: ["🔥 폴더블 최신작", "당근 단독 48만 추가할인", "당일 퀵 무료"],
    colors: [
      { name: "팬텀 블랙", hex: "#1c1c1e" },
      { name: "티타늄 그레이", hex: "#787679" },
      { name: "실버 섀도우", hex: "#d1d5db" },
    ],
    isHot: true,
    stockCount: 8,
    rating: 4.95,
  ...
  },
  {
    id: "galaxy-s26-ultra",
    name: "갤럭시 S26 울트라 5G",
    subName: "256GB / 2억 화소 스페이스 줌 • 차세대 AI",
    brand: "Samsung",
    image: "https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=500&auto=format&fit=crop&q=80",
    releasePrice: 1798500,
    carrierDiscounts: {
      skt: { gongsi: 550000, storeDiscount: 400000, defaultPlan: "5G 프라임 (월 8.9만)", planPrice: 89000 },
      kt: { gongsi: 560000, storeDiscount: 410000, defaultPlan: "스페셜 5G (월 9.0만)", planPrice: 90000 },
      lgu: { gongsi: 590000, storeDiscount: 430000, defaultPlan: "5G 프리미어 (월 8.5만)", planPrice: 85000 },
    },
    tags: ["⚡️ 이번 주 인기 1위", "당근 단독특가", "수도권 당일퀵"],
    colors: [
      { name: "티타늄 그레이", hex: "#787679" },
      { name: "티타늄 블랙", hex: "#2b2b2c" },
      { name: "티타늄 바이올렛", hex: "#5e5b72" },
    ],
    isHot: true,
    stockCount: 12,
    rating: 4.92,
  ...
  },
  {
    id: "iphone-17-pro",
    name: "아이폰 17 Pro",
    subName: "128GB / A19 Pro 칩셋 탑재 • 즉시개통",
    brand: "Apple",
    image: "https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=500&auto=format&fit=crop&q=80",
    releasePrice: 1550000,
    carrierDiscounts: {
      skt: { gongsi: 480000, storeDiscount: 350000, defaultPlan: "5G 프라임 (월 8.9만)", planPrice: 89000 },
      kt: { gongsi: 490000, storeDiscount: 360000, defaultPlan: "스페셜 5G (월 9.0만)", planPrice: 90000 },
      lgu: { gongsi: 520000, storeDiscount: 380000, defaultPlan: "5G 프리미어 (월 8.5만)", planPrice: 85000 },
    },
    tags: ["🍎 즉시 출고", "선택약정 25% 추천", "당일 안심배송"],
    colors: [
      { name: "딥 티타늄", hex: "#3a3b3e" },
